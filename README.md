...
*Figure 1*: Phase alignment between numerical RK4 integration and the exact analytical matrix exponential solution. Results are shown for incompressible flow vorticity at $\text{Re} = 1000$ (Left) and transonic flow pressure at $\text{Ma} = 0.50$ (Right).

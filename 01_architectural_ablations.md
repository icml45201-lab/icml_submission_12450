...
**Experiment:**  We compared our default Low-Rank Adaptation (LoRA) parameterization of the Koopman operator against a full-rank MLP ($K_{\mathrm{cont}} = \mathrm{MLP}(\phi)$) and an unconditional base model. 
